...
public class XPathFunctions {
     ...
     public static XdmValue executaXpath(String xp, String xmlFile) throws SaxonApiException {
        ...
        XdmValue resultado = selector.evaluate();
        return resultado;
    }
     
    public static String listaResultado(XdmValue lista){
